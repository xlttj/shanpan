...
/**
 * Marks a rule file as generated by shanpan. Pruning only ever deletes files
 * carrying this marker, so a rule the user wrote by hand is never touched.
 */
export const RULE_MARKER = '<!-- shanpan-managed-rule -->';

const FILE_PREFIX = 'shanpan-';
...
/** Delete shanpan-owned rule files that the current run did not write. */
